...
train_original = pd.read_csv('https://raw.githubusercontent.com/ravi-prakash-11/Minor-Project/main/train.csv')

test_original = pd.read_csv('https://raw.githubusercontent.com/ravi-prakash-11/Minor-Project/main/test.csv')
